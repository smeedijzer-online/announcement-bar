...
class Announcement_Settings {
	...
	public function __construct() {
		...
		add_filter( 'option_page_capability_announcement_plugin_options', array( $this, 'set_capability' ) );
	}

	/**
	 * Set capability for Editor role to save settings
	 *
	...
	public function add_plugin_page() {
		$this->menu_page = add_menu_page(
		 __( 'Notification Settings', 'announcement-bar' ),
